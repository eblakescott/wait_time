...
Location.create(title: 'Chicago Restaurant',
  ...
  image_url: 'chicago_restaurant.jpg')

#Seed data for Museums
Museum.delete_all
Museum.create(image_url: 'field_museum_2.jpg',
  name: 'Field Museum',  
description: 
    %{<p>
...
# . . .
Museum.create(image_url: 'shedd_aquarium.jpg',
  name: 'Shedd Aquarium',  
description:
    %{<p>
...
Museum.create(image_url: 'planetarium.jpg',
  name: 'Planetarium',
  description: 
    %{<p>
