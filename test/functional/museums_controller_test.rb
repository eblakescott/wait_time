...
class MuseumsControllerTest < ActionController::TestCase
  ...
  test "should create museum" do
    assert_difference('Museum.count') do
      post :create, museum: { description: @museum.description, image_url: @museum.image_url, name: @museum.name }
    end
  ...
  test "should update museum" do
    put :update, id: @museum, museum: { description: @museum.description, image_url: @museum.image_url, name: @museum.name }
    assert_redirected_to museum_path(assigns(:museum))
  end
